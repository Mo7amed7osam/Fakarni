...
- `01-home-voice-entry.jpg`
- `02-reminder-list.jpg`
- `03-manual-create.jpg`
- `04-settings-trust.jpg`
...
These were captured from the local iPhone simulator after a successful unsandboxed Debug simulator build.
